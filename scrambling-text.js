!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Scrambler = t() : e.Scrambler = t()
}(self, (function() {
    return (()=>{
        "use strict";
        var e = {
            d: (t,r)=>{
                for (var s in r)
                    e.o(r, s) && !e.o(t, s) && Object.defineProperty(t, s, {
                        enumerable: !0,
                        get: r[s]
                    })
            }
        ...
        class r {
            ...
            scramble(e, t, s=null) {
                this.characters = s?.characters ? [...s.characters] : [...r.CHARACTERS.DEFAULT],
                this.targetText = e,
                ...
                if (this.scrambledText === this.targetText)
                    ...
                    if (0 === this.frameIndex) {
                        ...
                        for (let t = 0; t < this.decodingCounters.length; t += 1)
                            0 !== this.decodingCounters[t] ? (e += this.characters[Math.floor(Math.random() * this.characters.length)],
                            this.decodingCounters[t] -= 1) : e += this.targetText[t];
