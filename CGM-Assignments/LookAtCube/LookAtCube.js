...
window.onload = function init() {
    ...
    // --------------- Event Listeners for Buttons and Sliders --------------- [Added by me]
    document.getElementById("perspective").onclick = function () {
        isPerspective = true;
        projectionMatrix = perspective(fovy, 1.0, near, far);
        gl.uniformMatrix4fv(projectionMatrixLoc, false, flatten(projectionMatrix));
        document.getElementById('perspective').style.background = '#CCC';
    ...
    document.getElementById("orthographic").onclick = function () {
        ...
        gl.uniformMatrix4fv(projectionMatrixLoc, false, flatten(projectionMatrix));
        document.getElementById('orthographic').style.background = '#CCC';
