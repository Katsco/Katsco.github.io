...
window.onload = function init() {
    ...
    // For the subdivisionsID and colorID, I had to change the names of the variables since they
    // were initialized under a different name in comparison to Mod 5 Assignment 2, Part 1
